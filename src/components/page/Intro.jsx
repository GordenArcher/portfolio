            ...
            <div className="relative">
                <div className="w-full h-full relative flex flex-col gap-10 md:flex-row" data-aos="fade-up">
                    <div className="w-full h-full">
                        <Link>
                            <button className="w-full h-[55px] text-xl !font-bold text-slate-100 bg-slate-700 border-0 cursor-pointer transition-all duration-500 ease hover:-translate-y-2 hover:text-slate-700 hover:bg-transparent hover:border-1 rounded-4xl" onClick={() => document.getElementById("portfolio").scrollIntoView({ behavior: "smooth" })}>View My work 💪🏽</button>
                        </Link>
                    </div>
