    ...
    <div className="relative !mt-4">
        <div className="flex flex-col gap-3.5">
            {Projects.map((project) => (
                <div key={project.id} className="grow realative">
                    <div className="flex max-md:flex-col max-md:items-start gap-4 md:gap-6 items-center rounded !p-3 hover:bg-gray-950 cursor-pointer">
                        <div className="relative !mr-2">
                            <img loading="lazy" width={200} height={300} className="rounded bg-gray-700 !p-2 max-md:w-full" src={project.project_preview} alt="thumbnail" />
                        </div>
